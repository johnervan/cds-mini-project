...
public class UsersControllerTest {
	...
	public void whenGetUsers_thenReturnJsonArray() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.get("/api/users")
				...
				.andExpect(MockMvcResultMatchers.jsonPath("data[0].name", Matchers.is(user.getName())))
				.andExpect(MockMvcResultMatchers.jsonPath("data[0].salary", Matchers.is(user.getSalary())));
	}
}
